...
using AnotherBanterBurger.Data;
using BanterBurger.Models;

namespace AnotherBanterBurger.Controllers
{
    public class BurgersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Bun,Patty,Condiments")] Burger burger)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,Bun,Patty,Condiments")] Burger burger)
        {
            if (id != burger.Id)
            {
                return NotFound();
